...
public class GameActivity extends AppCompatActivity {
    ...
    //This method will take the input and check it against the generated number. Depending on the outcome it will change the vew accordingly or take us to the ResultsActivity
    private void checkGuess(int userGuess) {
        if (userGuess == generatedNumber) {
            ...
            Toast.makeText(this, getString(R.string.chances_left,(5 - numberOfGuesses)), Toast.LENGTH_LONG).show();
        } else if (userGuess > generatedNumber) {
